...
ExFatImage::ExFatImage(unsigned char * volume)
{
	cout << "start Image Init\n";
	image = &(*volume);
}

void ExFatImage::fullInitExfatImage() {

	ExFatImage::setBootRegionBootSector();						// Инициализация Boot Sector		
	ExFatImage::setBootRegionExtendedBootSectors();			// Инициализация Extended Boot Sector		
	ExFatImage::setBootRegionOemParametrs();					// Инициализация Boot Region Oem Parametrs		
	ExFatImage::setBootRegionReserved();						// Инициализация Boot Region Reserved		
	ExFatImage::setBootRegionChecksum();						// Инициализация Boot Region Checksum		

	ExFatImage::setFatRegionFatAligment();
	ExFatImage::setFatRegionFirstFat();

	ExFatImage::setDataRegionClusterHeapAligment();
	ExFatImage::setDataRegionUpcaseTable();
	ExFatImage::setDataRegionVolumeLabel();
	ExFatImage::setDataRegionAllocationBitMapEntry();
	ExFatImage::setDataRegionUpCaseTableEntry(); 
}


void ExFatImage::printExFatParametrs()
{
...
void ExFatImage::setBootRegionBootSector()
{
...
void ExFatImage::setBootRegionExtendedBootSectors()
{
...
void ExFatImage::setBootRegionOemParametrs()
{
...
void ExFatImage::setBootRegionReserved()
{
...
void ExFatImage::setBootRegionChecksum()
{
...
void ExFatImage::setFatRegionFatAligment() {
...
void ExFatImage::setFatRegionFirstFat() {
...
void ExFatImage::setDataRegionClusterHeapAligment() {
...
void ExFatImage::setDataRegionVolumeLabel() {
...
void ExFatImage::setDataRegionUpcaseTable() {
...
void ExFatImage::setDataRegionAllocationBitMapEntry() {
...
void ExFatImage::setDataRegionUpCaseTableEntry() {
...
void ExFatImage::writeFileEntry(char fileName[], unsigned int fileNumber, unsigned int fileLength, unsigned int fileFirstCluster) {

	// File Directory Entry
	// ------------------------------------------------------------------------------------------------------------------------------
	unsigned int  offsetEntry = (clusterHeapOffset + sectorsPerCluster * 3) * bytePerSector + 32 * (4 * fileNumber);
...
void ExFatImage::writeFileDataRegion(char file[], int fileSize, int firstClusterOfFile) {
...
void ExFatImage::writeFileBitMap(int fileSize, int firstClusterOfFile) {
...
void ExFatImage::writeFileFatTable(int fileSize, int firstClusterOfFile) {
...
void ExFatImage::writeFileToImage(char file[], int fileSize, char fileName[], unsigned int fileNumber, int firstClusterOfFile) {
	
	ExFatImage::writeFileDataRegion	(file, fileSize, firstClusterOfFile);
	ExFatImage::writeFileFatTable	(fileSize, firstClusterOfFile);
	ExFatImage::writeFileEntry		(fileName, fileNumber, fileSize, firstClusterOfFile);
	ExFatImage::writeFileBitMap		(fileSize, firstClusterOfFile);
}
